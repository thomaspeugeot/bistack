...
func (controller *Controller) onWebSocketRequestForCommitFromBackNb(c *gin.Context) {
	...
	// log.Println("Stack github.com/thomaspeugeot/bistack/go, onWebSocketRequestForCommitFromBackNb")
...
func (controller *Controller) onWebSocketRequestForBackRepoContent(c *gin.Context) {
	...
	// log.Println("Stack github.com/thomaspeugeot/bistack/go, onWebSocketRequestForBackRepoContent, first sent back repo of", stackPath)
	if err != nil {
		log.Println("client no longer receiver web socket message, assuming it is no longer alive, closing websocket handler")
		fmt.Println(err)
		return
	...
	for nbCommitBackRepo := range updateCommitBackRepoNbChannel {
		...
		// log.Println("Stack github.com/thomaspeugeot/bistack/go, onWebSocketRequestForBackRepoContent, sent back repo of", stackPath)
