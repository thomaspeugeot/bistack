...
import (
	...
	bistack_orm "github.com/thomaspeugeot/bistack/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*bistack_orm.BackRepoStruct
}
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*bistack_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *bistack_orm.BackRepoStruct, stackPath string) {
