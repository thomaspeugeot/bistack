...
import (
	...
	"github.com/thomaspeugeot/bistack/go/fullstack"
	"github.com/thomaspeugeot/bistack/go/models"
	"github.com/thomaspeugeot/bistack/go/orm"
	"github.com/thomaspeugeot/bistack/go/probe"

	bistack_go "github.com/thomaspeugeot/bistack/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/thomaspeugeot/bistack/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, bistack_go.GoModelsDir, bistack_go.GoDiagramsDir,
