...
import (
	...
	"github.com/thomaspeugeot/bistack/otherstack"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(otherstack.NgDistNg, "ng-github.com-thomaspeugeot-bistack-otherstack/dist/ng-github.com-thomaspeugeot-bistack-otherstack/browser")))
