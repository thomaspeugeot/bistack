...
import (
	...
	"github.com/thomaspeugeot/bistack/otherstack/go/fullstack"
	"github.com/thomaspeugeot/bistack/otherstack/go/models"
	"github.com/thomaspeugeot/bistack/otherstack/go/orm"
	"github.com/thomaspeugeot/bistack/otherstack/go/probe"

	otherstack_go "github.com/thomaspeugeot/bistack/otherstack/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/thomaspeugeot/bistack/otherstack/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, otherstack_go.GoModelsDir, otherstack_go.GoDiagramsDir,
