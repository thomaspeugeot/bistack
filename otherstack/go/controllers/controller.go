...
import (
	...
	otherstack_orm "github.com/thomaspeugeot/bistack/otherstack/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*otherstack_orm.BackRepoStruct
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*otherstack_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *otherstack_orm.BackRepoStruct, stackPath string) {
