...
import * as otherstack from '../../projects/otherstack/src/public-api'

import { OtherstackspecificComponent } from '../../projects/otherstackspecific/src/public-api'
...
export class AppComponent implements OnInit {
  ...
  probe = 'Otherstack Data/Model'
  view = this.otherstack

  views: string[] = [this.otherstack, this.probe];
